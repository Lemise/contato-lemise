...
<head>
  ...
  <title>Contato Oficial | Lemise</title>
  <meta name="description" content="Fale com a equipe da Lemise pelo nosso número oficial no WhatsApp. Atendimento rápido e personalizado." />

  <!-- Google Analytics -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-BD8WBNSCS8"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
    gtag('config', 'G-BD8WBNSCS8');
  </script>
...
<body>
  ...
  document.querySelectorAll('.btn').forEach(button => {
    button.addEventListener('click', function() {
      const vendedora = this.getAttribute('data-vendedora');
